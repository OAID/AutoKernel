...
{
    node_t softmax_node = create_graph_node(graph, node_name, "FullyConnected");
...
graph_t create_softmax_graph(int c, int output_c)
{
    ...
    if(create_fc_node(graph, softmax_name, input_name, c, output_c) < 0)
    {
