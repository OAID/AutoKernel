#ifndef HALIDE_____halide_depthwise_h
#define HALIDE_____halide_depthwise_h
#include <stdint.h>
...
int halide_depthwise(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_kernel_buffer, struct halide_buffer_t *_bias_buffer, int32_t _stride, int32_t _pad_width, int32_t _pad_height, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int halide_depthwise_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *halide_depthwise_metadata();
