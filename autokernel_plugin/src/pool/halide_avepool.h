#ifndef HALIDE_____halide_avepool_h
#define HALIDE_____halide_avepool_h
#include <stdint.h>
...
int halide_avepool(struct halide_buffer_t *_input_buffer, int32_t _stride, int32_t _pad_width, int32_t _height, int32_t _kernel_w, int32_t _kernel_h, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int halide_avepool_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *halide_avepool_metadata();
