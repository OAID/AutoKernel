#ifndef HALIDE_____halide_maxpool_h
#define HALIDE_____halide_maxpool_h
#include <stdint.h>
...
int halide_maxpool(struct halide_buffer_t *_input_buffer, int32_t _stride, int32_t _pad_width, int32_t _height, int32_t _kernel_w, int32_t _kernel_h, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int halide_maxpool_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *halide_maxpool_metadata();
