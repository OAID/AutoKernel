#ifndef HALIDE_____halide_direct_conv_h
#define HALIDE_____halide_direct_conv_h
#include <stdint.h>
...
int halide_direct_conv(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_kernel_buffer, struct halide_buffer_t *_bias_buffer, int32_t _input_depth, int32_t _stride, int32_t _pad_width, int32_t _pad_height, int32_t _act, struct halide_buffer_t *_relu_buffer);

HALIDE_FUNCTION_ATTRS
int halide_direct_conv_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *halide_direct_conv_metadata();
